...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:Dexte1r2d!@localhost/marvel'
...
def create_database():
    root_engine = create_engine("mysql+mysqlconnector://root:Dexte1r2d!@localhost")  # No database specified
